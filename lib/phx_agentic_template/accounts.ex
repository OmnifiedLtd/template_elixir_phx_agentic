defmodule PhxAgenticTemplate.Accounts do
  @moduledoc """
  ...
  alias PhxAgenticTemplate.Accounts.{User, UserToken, UserNotifier}
  ...
  See `PhxAgenticTemplate.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PhxAgenticTemplate.Accounts.User.password_changeset/3` for a list of supported options.
